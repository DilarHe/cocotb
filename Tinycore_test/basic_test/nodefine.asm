.CONV1
lw x4 __CONV1._filter_p(x2) 
.C1LOADBIAS
lw x6 __CONV1._bias_p(x2) 
lv v8 0(x6)
addi x6 x6 1
lv v12 0(x6)
addi x6 x6 1
...
lw x3 __CONV1._ifmap_p(x2) 
lw x5 __CONV1._inner_cnt(x2) 
.INNERLOOP
addi4spn x6 16 
addi4spn x7 16 
lv v0 0(x3) 
...
bnez x5 .C1RELU
.C1STORE16
lw x5 __CONV1._ofmap_p(x2) 
sv1 x0 0(x5)
addi x5 x5 1
sw x5 __CONV1._ofmap_p(x2) 
.C1CHECKOUTLOOP 
lw x5 __CONV1._outer_cnt(x2) 
addi x5 x5 -1
bnez x5 2
jr x1
...
j .C1LOADBIAS
.DEPTHWISE_CONV_FUN
lw x3 __DEPTHWISE_CONV_FUN._ifmap_start_p(x2) 
lw x4 __DEPTHWISE_CONV_FUN._filter_start_p(x2) 
.DW_LOADBIAS
lw x6 __DEPTHWISE_CONV_FUN._bias_p(x2) 
lv v8 0(x6)
addi x6 x6 1
lv v12 0(x6)
addi x6 x6 1
...
lw x5 __DEPTHWISE_CONV_FUN._conv_width(x2) 
.DWINNERLOOP
lv v0 0(x3) 
mv x7 x3
lw x6 __DEPTHWISE_CONV_FUN._fmap_fifo_end_p(x2) 
sub x7 x7 x6
beqz x7 .DWIFMAP_RETURN_START
addi x3 x3 3 
j .DW_LOAD_WEIGHT
.DWIFMAP_RETURN_START
lw x3 __DEPTHWISE_CONV_FUN._fmap_fifo_start_p(x2) 
.DW_LOAD_WEIGHT
lv v4 0(x4) 
addi x4 x4 3 
addi4spn x7 16 
...
nop
.DW_QUANT16
lw x6 __DEPTHWISE_CONV_FUN._quant_p(x2) 
lv v0 0(x6) 
addi4spn x6 16 
addi4spn x5 16 
.DW_RELU
...
bnez x5 .DW_RELU
.DW_STORE16
lw x5 __DEPTHWISE_CONV_FUN._ofmap_p(x2) 
sv1 x0 0(x5)
addi x5 x5 1
sw x5 __DEPTHWISE_CONV_FUN._ofmap_p(x2) 
.DW_CHECKOUTLOOP 
lw x5 __DEPTHWISE_CONV_FUN._outer_cnt(x2) 
addi x5 x5 -1
bnez x5 2
jr x1
sw x5 __DEPTHWISE_CONV_FUN._outer_cnt(x2)
lw x5 __DEPTHWISE_CONV_FUN._fmap_fifo_end_p(x2) 
addi x5 x5 1
sw x5 __DEPTHWISE_CONV_FUN._fmap_fifo_end_p(x2) 
lw x5 __DEPTHWISE_CONV_FUN._fmap_fifo_start_p(x2) 
addi x5 x5 1
sw x5 __DEPTHWISE_CONV_FUN._fmap_fifo_start_p(x2) 
lw x3 __DEPTHWISE_CONV_FUN._ifmap_start_p(x2) 
addi x3 x3 1
sw x3 __DEPTHWISE_CONV_FUN._ifmap_start_p(x2) 
lw x4 __DEPTHWISE_CONV_FUN._filter_start_p(x2) 
addi x4 x4 1
sw x4 __DEPTHWISE_CONV_FUN._filter_start_p(x2) 
j .DW_LOADBIAS
.SKIP_ADD_FUNCTION
lw x3 __SKIP_ADD._sk_params_p(x2) 
lv v0 0(x3)
nop 
nop
mv x4 x11 
...
mvimmx4 x4 0
sw x4 __IBB1._c1_out_x(x3) 
mvimmx4 x4 308
sw x4 __IBB1._dw_ifmap_p(x3) 
.IBB1_C1ANDSKIP_CONV
addi4spn x2 0
addi4spn x3 21
mvimmx4 x4 505 
...
slli x4 x4 1
addi x4 x4 -1 
sw x4 __DEPTHWISE_CONV_FUN._conv_width(x2) 
mv x6 x4 
mvimmx4 x4 308
sw x4 __DEPTHWISE_CONV_FUN._ifmap_start_p(x2) 
addi4spn x7 9
sub x7 x7 x6 
mv x5 x7
slli x7 x7 1 
...
slli x4 x4 1
sub x5 x5 x4 
sw x5 __DEPTHWISE_CONV_FUN._conv_width(x2) 
mvimmx4 x4 518
sw x4 __DEPTHWISE_CONV_FUN._filter_start_p(x2) 
j .IBB1_CHECK_DW_IFMAP_POINT
...
sw x6 __IBB1._dw_ifmap_p(x3) 
sw x6 __DEPTHWISE_CONV_FUN._ifmap_start_p(x2) 
.IBB1_DWCONV_MAIN
mvimmx4 x4 545 
...
mvimmx4 x4 3
sw x4 __DEPTHWISE_CONV_FUN._outer_cnt(x2) 
mvimmx4 x4 308
sw x4 __DEPTHWISE_CONV_FUN._fmap_fifo_start_p(x2)
mvimmx4 x4 332
sw x4 __DEPTHWISE_CONV_FUN._fmap_fifo_end_p(x2) 
...
addi4spn x5 0
addi x5 x5 -1
sw x5 __TOPCTRL._kws_output(x2) 
addi4spn x2 26
addi4spn x5 0 
lw x6 __SMOUT._numerator_0(x2) 
addi4spn x3 6
addi4spn x8 1
...
addi4spn x2 43
add x2 x2 x5 
lw x4 __KWS_CONFIG._kwscfg_threshold_0(x2) 
addi x4 x4 1
addi4spn x2 26
...
lw x7 __TOPCTRL._max_index_last(x2) 
sub x7 x7 x5
bnez x7 2
addi x4 x4 1
addi4spn x4 1
...
lw x7 __KWS_CONFIG._kwscfg_eva_num_group_0(x2) 
sub x4 x4 x7
...
.ELSE_EVANUM1
lw x7 __KWS_CONFIG._kwscfg_eva_num_group_1(x2) 
sub x4 x4 x7
bnez x4 .UPDATE_MAX_VALUE_LAST 
sw x5 __TOPCTRL._kws_output(x3)
...
sw x5 __TOPCTRL._max_index_last(x3) 
addi4spn x1 27 
addi4spn x1 0 
.NN_END
nop
